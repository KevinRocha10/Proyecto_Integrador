        ...
        <div class="central">
            <ul class="slider" id="#slider">
              ...
              <li id="slider__1"><video  width=800  height=500 controls autoplay loop >
                <source src="Multimedia/Tema_4.mp4" type="video/mp4">
                </video></li>
...
$query = "SELECT * FROM tabla_imagen JOIN temario ON temario.id_tem=tabla_imagen.contenido WHERE tabla_imagen.contenido='4'";
...
<!--Video-->
<li><a href="#slider__1">Lexico</a></li>
<!--Video-->
