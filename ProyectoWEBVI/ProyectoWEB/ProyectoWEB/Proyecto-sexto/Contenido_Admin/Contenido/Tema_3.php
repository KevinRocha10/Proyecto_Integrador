...
<div class="container">
     ...
     <li id="slider__1"><video  width=800  height=500 controls autoplay loop>
                <source src="Multimedia/Tema_3.mp4" type="video/mp4">
                </video></li>
...
$query = "SELECT * FROM tabla_imagen JOIN temario ON temario.id_tem=tabla_imagen.contenido WHERE tabla_imagen.contenido='3'";
...
<ul class="botones">
          ...
          <!--Video-->
<li><a href="#slider__1">Vocabulario</a></li>
<!--Video-->
